...
# File: VRL.tcl
# Generated on: Sun Apr 18 22:34:46 2021
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "VRL"]} {
		puts "Project VRL is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists VRL]} {
		project_open -revision VRL VRL
	} else {
		project_new -revision VRL VRL
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name SEARCH_PATH "c:\\intelfpga\\18.1\\vrl\\oqpsk_mod"
	set_global_assignment -name SEARCH_PATH "c:\\intelfpga\\18.1\\vrl\\oqpsk_dmod"
	...
	set_global_assignment -name VERILOG_FILE DE1_SOC_golden_top.v
	set_global_assignment -name SYSTEMVERILOG_FILE OQPSK_DMOD/OQPSK_RSCH.sv
	set_global_assignment -name VERILOG_FILE OQPSK_MOD/OQPSK_MOD.v
	set_global_assignment -name SDC_FILE DE1_SOC_golden_top.sdc
	set_global_assignment -name SYSTEMVERILOG_FILE VRL.sv
	set_global_assignment -name VECTOR_WAVEFORM_FILE Waveform.vwf
	set_global_assignment -name SYSTEMVERILOG_FILE SHIFT_S.sv
	set_global_assignment -name SYSTEMVERILOG_FILE SH.sv
	...
	set_global_assignment -name VERILOG_FILE oqpsk_mod/shift_q.v
	set_global_assignment -name SOURCE_FILE db/VRL.cmp.rdb
